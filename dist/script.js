...
function forms() {
  ...
  formsList.forEach(form => {
    ...
    form.addEventListener('submit', event => {
      ...
      postData('./assets/server.php').then(response => {
        console.log(response);
        status.textContent = statusMessage.success;
      }).catch(() => status.textContent = statusMessage.failure).finally(() => {
        clearInputs(form);
        setTimeout(() => {
          status.remove();
        }, 5000);
...
/* harmony export */ });
function tabs(containerSelector, triggerSelector, contentSelector, triggerActiveClass, linkActiveClass) {
  ...
  function showTab() {
    let tabIndex = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.glazing', '.glazing_block', '.glazing_content', null, 'active');
  (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.decoration', '.decoration_item > div', '.decoration_content > .row > div', 'after_click');
